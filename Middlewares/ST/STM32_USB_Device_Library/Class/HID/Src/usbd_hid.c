...
__ALIGN_BEGIN static uint8_t USBD_HID_CfgDesc[USB_HID_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  0x05,                                               /* nInterfaceProtocol : 0=none, 1=keyboard, 2=mouse */
...
__ALIGN_BEGIN static uint8_t HID_MOUSE_ReportDesc[HID_MOUSE_REPORT_DESC_SIZE] __ALIGN_END =
{
	...
	0x95, 0x18,                    //     REPORT_COUNT (24) nombre fois d'element de report size (multiple de 8bit (1 octet)) Ici 20 boutons donc 24
	0x75, 0x01,                    //     REPORT_SIZE (1) taille de chaque bouton. Ici 1 bit
